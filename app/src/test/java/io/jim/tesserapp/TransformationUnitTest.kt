...
class TransformationUnitTest {
    ...
    @Test
    fun translation() {
        val m = Matrix(2).translation(Direction(2.0, 1.0))
    ...
    fun spaces() {
        val i = Matrix(3)
        val m = Matrix(3).space(Point(0.0, 0.0, 0.0),
        ...
        val n = Matrix(3).space(Point(0.0, 0.0, 0.0),
    ...
    @Test
    fun perspective() {
        assertEquals(2.0 / 10.0, (Point(2.0, 3.0, -10.0) * Matrix(3).perspective()).x, 0.1)
    ...
    @Test
    fun combination() {
        val m = Matrix(3).scale(2.0) * Matrix(3).translation(Direction(4.0, 0.0, 0.0))
