...
class GeometryBufferTest {
    ...
    fun init() {
        ...
        geometryBuffer.recordGeometries(rotationSpatial)
        ...
        rotationSpatial.rotationYX(PI / 2)
        ...
        geometryBuffer.recordGeometries(translationSpatial)
        assertEquals(translationSpatial.matrixOffset, maxModels + 1)
        assertEquals(translationSpatial.matrixGlobal, 0)

        // TODO: Check for translation matrix to be preserved:
